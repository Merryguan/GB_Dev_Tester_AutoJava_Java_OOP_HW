...
public class Main {
    public static void main(String[] args) {
        ...
        hotDrinkList1.add(new HotDrinkExt("Кофе", 150, 200, 80));
        hotDrinkList1.add(new HotDrinkExt("Чай", 50, 300, 100));
        hotDrinkList1.add(new HotDrinkExt("Какао", 100, 250, 70));
        ...
        hotDrinkList2.add(new HotDrinkExt("Кофе", 200, 250, 80));
        hotDrinkList2.add(new HotDrinkExt("Чай", 75, 350, 100));
        hotDrinkList2.add(new HotDrinkExt("Какао", 150, 225, 70));
